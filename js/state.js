...
TR.nl = {
 ...
 auth_err_invalid:"E-mail of wachtwoord klopt niet.",auth_err_already:"Dit e-mailadres is al in gebruik.",auth_err_minpw:"Wachtwoord moet minstens 6 tekens zijn.",auth_err_connect:"Verbinding mislukt. Probeer opnieuw.",auth_check_email:"Bevestig je e-mailadres om je account te activeren.",auth_err_rate_limit:"Te veel pogingen. Probeer het later opnieuw.",auth_err_unconfirmed:"Account nog niet bevestigd via e-mail. Check je inbox.",auth_resend:"Bevestigingsmail opnieuw versturen",auth_resent:"Bevestigingsmail opnieuw verstuurd.",auth_err_unknown:"Onbekende fout — probeer het opnieuw.",lb_long_break_title:"Tijd voor een langere pauze?",lb_long_break_body:"Je hebt 4 focus-blokken op rij gepland. Een langere pauze helpt je echt resetten.",lb_long_break_skip:"Nee, laat maar",lb_long_break_added:"Pauze van {n} min toegevoegd",lb_long_break_note:"Lange pauze",lb_unknown_friend:"Vriend",fr_timeout:"De server reageert niet. Check je verbinding.",fr_rls_hint:"Database-toegang geweigerd. Controleer je RLS-policies in Supabase.",
