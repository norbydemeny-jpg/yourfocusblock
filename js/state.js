...
/* ---- persistent state ---- */
let S = {
  focus:50, short:10, long:25, longAfter:4, weeklyGoal:15,
...
en:{
 ...
 home_vp_head:"Built to keep you focused",
 home_vp_plan_t:"Plan smart",home_vp_plan_d:"Turn your day into a few focused blocks — built in seconds.",
 home_vp_focus_t:"Focus deep",home_vp_focus_d:"A calm timer, gentle breaks, zero distractions.",
 home_vp_together_t:"Better together",home_vp_together_d:"See friends study live and keep each other going.",
 home_join_t:"Study together",home_join_d:"Add friends, see who's focusing right now, and keep each other motivated.",home_join_cta:"Create free account",
 home_divider_plan:"Or plan ahead",color:"Color",fill_fields:"Fill in subject and date.",
 home_social_studying_now:"friends focusing now",home_social_on_break:"on a break",home_social_invite:"Add friend",home_social_invite_short:"Invite",
 nextup_label:"Coming up",nextup_label_today:"On today's plan",nextup_today:"today",nextup_tomorrow:"tomorrow",nextup_in_days:"in <b>{n} days</b>",
 nextup_exam:"{subj} exam {when}",nextup_today_blocks:"{blk} planned today",nextup_today_only:"{blk} planned — ready when you are",n_block:"block",n_blocks:"blocks",
 ...
 no_subj_data:"Finish some focus sessions to see your subject breakdown.",subj_add_cta:"Add subjects",home_subj_nudge_t:"Track your subjects",home_subj_nudge_d:"Add subjects so you can see exactly where your study time goes.",home_subj_nudge_btn:"Add subjects",
 // settings
 ...
 dpl_start:"Start",dpl_until:"Until",dpl_planned:"Planned",dpl_done_by:"Done by",dpl_endtime:"End time",
 ...
 qa_pop_title:"Quick add",qa_dur:"Duration",qa_amount:"How many",qa_subj_opt:"Subject (optional)",qa_subj_none:"None",qa_add_n:"＋ Add {n}",qa_incl_breaks:"breaks included",qa_added_n:"{n} blocks added",
 ...
 // global nav + dagoverzicht
 nav_today:"Today",nav_overview:"Day overview",nav_stats:"Stats & friends",nav_stats_short:"Stats",nav_quick_short:"Quick",
 ov_total_today:"Total focus today",ov_progress:"Progress",ov_blocks_planned:"blocks planned",
 ov_week_goal:"Weekly goal",ov_of:"of",ov_tips_today:"Tip for today",
 ov_today:"Today",ov_together:"Focused together",ov_friend_online:"friend online",ov_friends_online:"friends online",
 ov_no_friends_active:"No friends studying right now. Invite some to stay motivated together.",
 ov_cheer_start:"Let's begin.",ov_cheer_good:"Good start!",ov_cheer_busy:"Keep it up!",ov_cheer_goal:"Goal reached!",
 ov_empty_t:"No plan yet for today",ov_empty_d:"Plan your day with focus blocks, breaks and tasks.",
 ...
 pq_how_many:"How many?",pq_per_block:"Duration per block",pq_total_focus:"total focus",pq_auto_break:"Breaks in between",
 ...
 auth_err_invalid:"E-mail or password is incorrect.",auth_err_already:"This e-mail is already in use.",auth_err_minpw:"Password must be at least 6 characters.",auth_err_connect:"Connection failed. Please try again.",auth_check_email:"Confirm your email address to activate your account.",auth_err_rate_limit:"Too many attempts. Please try again later.",auth_err_unconfirmed:"Your account isn't confirmed yet. Check your inbox.",auth_resend:"Resend confirmation",auth_resent:"Confirmation e-mail sent.",auth_err_unknown:"Unknown error — please try again.",lb_long_break_title:"Time for a longer break?",lb_long_break_body:"You've planned 4 focus blocks in a row. A longer break really helps you reset.",lb_long_break_skip:"No thanks",lb_long_break_added:"{n} min break added",lb_long_break_note:"Long break",pause_streak_q:"{n} blocks without a break — add one?",pause_add:"＋ Break",timer_extended:"+{n} min added",lb_unknown_friend:"Friend",fr_timeout:"Server isn't responding. Check your connection.",fr_rls_hint:"Database access denied. Check your RLS policies in Supabase.",
 // Friends modal
 ...
 agdo_plan_desc:"Split your day into focus blocks",agdo_edit_desc:"Adjust blocks, times and subjects",agdo_remove_desc:"Clear this day's study plan",agdo_exam_desc:"Mark an exam on this day",agdo_empty:"Nothing planned yet",
 // Settings extras
...
TR.nl = {
 ...
 home_vp_head:"Gemaakt om je gefocust te houden",
 home_vp_plan_t:"Plan slim",home_vp_plan_d:"Zet je dag om in een paar gefocuste blokken — in seconden klaar.",
 home_vp_focus_t:"Focus diep",home_vp_focus_d:"Een rustige timer, zachte pauzes, nul afleiding.",
 home_vp_together_t:"Samen sterker",home_vp_together_d:"Zie vrienden live studeren en houd elkaar op gang.",
 home_join_t:"Studeer samen",home_join_d:"Voeg vrienden toe, zie wie nu focust en motiveer elkaar.",home_join_cta:"Maak gratis account",
 home_divider_plan:"Of plan vooruit",color:"Kleur",fill_fields:"Vul vak en datum in.",
 home_social_studying_now:"vrienden studeren nu",home_social_on_break:"op pauze",home_social_invite:"Vriend toevoegen",home_social_invite_short:"Nodig uit",
 nextup_label:"Straks op het programma",nextup_label_today:"Vandaag op het programma",nextup_today:"vandaag",nextup_tomorrow:"morgen",nextup_in_days:"over <b>{n} dagen</b>",
 nextup_exam:"{subj}-examen {when}",nextup_today_blocks:"{blk} gepland vandaag",nextup_today_only:"{blk} gepland — klaar om te beginnen",n_block:"blok",n_blocks:"blokken",
 ...
 no_subj_data:"Maak een paar focussessies af om je verdeling per vak te zien.",subj_add_cta:"Vakken toevoegen",home_subj_nudge_t:"Voeg je vakken toe",home_subj_nudge_d:"Met vakken zie je precies waar je studietijd naartoe gaat.",home_subj_nudge_btn:"Vakken toevoegen",
 ...
 dpl_start:"Start",dpl_until:"Tot",dpl_planned:"Gepland",dpl_done_by:"Klaar om",dpl_endtime:"Eindtijd",
 ...
 qa_pop_title:"Snel toevoegen",qa_dur:"Duur",qa_amount:"Hoeveel",qa_subj_opt:"Vak (optioneel)",qa_subj_none:"Geen",qa_add_n:"＋ {n} toevoegen",qa_incl_breaks:"pauzes inbegrepen",qa_added_n:"{n} blokken toegevoegd",
 ...
 nav_today:"Vandaag",nav_overview:"Dagoverzicht",nav_stats:"Statistieken & vrienden",nav_stats_short:"Statistieken",nav_quick_short:"Snel",
 ov_total_today:"Totaal focus vandaag",ov_progress:"Voortgang",ov_blocks_planned:"blokken gepland",
 ov_week_goal:"Doel deze week",ov_of:"van",ov_tips_today:"Tip voor vandaag",
 ov_today:"Vandaag",ov_together:"Samen gefocust",ov_friend_online:"vriend online",ov_friends_online:"vrienden online",
 ov_no_friends_active:"Geen vrienden aan het leren nu. Nodig er een paar uit om samen gemotiveerd te blijven.",
 ov_cheer_start:"Laten we beginnen.",ov_cheer_good:"Goede start!",ov_cheer_busy:"Goed bezig!",ov_cheer_goal:"Doel bereikt!",
 ov_empty_t:"Nog geen plan voor vandaag",ov_empty_d:"Plan je dag met focusblokken, pauzes en taken.",
 ...
 pq_how_many:"Hoeveel?",pq_per_block:"Duur per blok",pq_total_focus:"totale focus",pq_auto_break:"Pauze ertussen",
 ...
 auth_err_invalid:"E-mail of wachtwoord klopt niet.",auth_err_already:"Dit e-mailadres is al in gebruik.",auth_err_minpw:"Wachtwoord moet minstens 6 tekens zijn.",auth_err_connect:"Verbinding mislukt. Probeer opnieuw.",auth_check_email:"Bevestig je e-mailadres om je account te activeren.",auth_err_rate_limit:"Te veel pogingen. Probeer het later opnieuw.",auth_err_unconfirmed:"Account nog niet bevestigd via e-mail. Check je inbox.",auth_resend:"Bevestigingsmail opnieuw versturen",auth_resent:"Bevestigingsmail opnieuw verstuurd.",auth_err_unknown:"Onbekende fout — probeer het opnieuw.",lb_long_break_title:"Tijd voor een langere pauze?",lb_long_break_body:"Je hebt 4 focus-blokken op rij gepland. Een langere pauze helpt je echt resetten.",lb_long_break_skip:"Nee, laat maar",lb_long_break_added:"Pauze van {n} min toegevoegd",lb_long_break_note:"Lange pauze",pause_streak_q:"{n} blokken zonder pauze — pauze inlassen?",pause_add:"＋ Pauze",timer_extended:"+{n} min toegevoegd",lb_unknown_friend:"Vriend",fr_timeout:"De server reageert niet. Check je verbinding.",fr_rls_hint:"Database-toegang geweigerd. Controleer je RLS-policies in Supabase.",
 ...
 agdo_plan_desc:"Verdeel je dag in focusblokken",agdo_edit_desc:"Pas blokken, tijden en vakken aan",agdo_remove_desc:"Wis het studieplan van deze dag",agdo_exam_desc:"Markeer een examen op deze dag",agdo_empty:"Nog niets gepland",
...
TR.fr = {
 ...
 home_vp_head:"Conçu pour te garder concentré",
 home_vp_plan_t:"Planifie malin",home_vp_plan_d:"Transforme ta journée en quelques blocs concentrés — prêt en secondes.",
 home_vp_focus_t:"Concentration profonde",home_vp_focus_d:"Un minuteur calme, des pauses douces, zéro distraction.",
 home_vp_together_t:"Mieux ensemble",home_vp_together_d:"Vois tes amis étudier en direct et motivez-vous.",
 home_join_t:"Étudiez ensemble",home_join_d:"Ajoute des amis, vois qui se concentre maintenant et motivez-vous.",home_join_cta:"Créer un compte gratuit",
 home_divider_plan:"Ou planifie à l'avance",color:"Couleur",fill_fields:"Renseigne la matière et la date.",
 home_social_studying_now:"amis se concentrent",home_social_on_break:"en pause",home_social_invite:"Ajouter un ami",home_social_invite_short:"Inviter",
 nextup_label:"À venir",nextup_label_today:"Au programme aujourd'hui",nextup_today:"aujourd'hui",nextup_tomorrow:"demain",nextup_in_days:"dans <b>{n} jours</b>",
 nextup_exam:"examen de {subj} {when}",nextup_today_blocks:"{blk} au programme",nextup_today_only:"{blk} au programme — prêt quand tu veux",n_block:"bloc",n_blocks:"blocs",
 ...
 no_subj_data:"Termine quelques sessions pour voir la répartition par matière.",subj_add_cta:"Ajouter des matières",home_subj_nudge_t:"Ajoute tes matières",home_subj_nudge_d:"Avec des matières, tu vois où va vraiment ton temps d'étude.",home_subj_nudge_btn:"Ajouter des matières",
 ...
 dpl_start:"Début",dpl_until:"Jusqu'à",dpl_planned:"Planifié",dpl_done_by:"Terminé à",dpl_endtime:"Fin",
 ...
 qa_pop_title:"Ajout rapide",qa_dur:"Durée",qa_amount:"Combien",qa_subj_opt:"Matière (facultatif)",qa_subj_none:"Aucune",qa_add_n:"＋ Ajouter {n}",qa_incl_breaks:"pauses incluses",qa_added_n:"{n} blocs ajoutés",
 ...
 nav_today:"Aujourd'hui",nav_overview:"Aperçu du jour",nav_stats:"Stats & amis",nav_stats_short:"Stats",nav_quick_short:"Rapide",
 ov_total_today:"Focus total aujourd'hui",ov_progress:"Progression",ov_blocks_planned:"blocs prévus",
 ov_week_goal:"Objectif de la semaine",ov_of:"sur",ov_tips_today:"Conseil du jour",
 ov_today:"Aujourd'hui",ov_together:"Concentrés ensemble",ov_friend_online:"ami en ligne",ov_friends_online:"amis en ligne",
 ov_no_friends_active:"Aucun ami n'étudie en ce moment. Invite-en pour rester motivés ensemble.",
 ov_cheer_start:"Commençons.",ov_cheer_good:"Bon début !",ov_cheer_busy:"Continue !",ov_cheer_goal:"Objectif atteint !",
 ov_empty_t:"Pas encore de plan pour aujourd'hui",ov_empty_d:"Planifie ta journée avec des blocs de focus, des pauses et des tâches.",
 ...
 unit_h_short:"h",unit_min_short:"min",
 pq_how_many:"Combien ?",pq_per_block:"Durée par bloc",pq_total_focus:"de focus total",pq_auto_break:"Pauses entre les blocs",
 ...
 auth_err_invalid:"E-mail ou mot de passe incorrect.",auth_err_already:"Cet e-mail est déjà utilisé.",auth_err_minpw:"Le mot de passe doit faire au moins 6 caractères.",auth_err_connect:"Connexion échouée. Réessaie.",auth_check_email:"Confirmez votre adresse e-mail pour activer votre compte.",auth_err_rate_limit:"Trop de tentatives. Veuillez réessayer plus tard.",auth_err_unconfirmed:"Compte non confirmé. Vérifie ta boîte mail.",auth_resend:"Renvoyer le mail de confirmation",auth_resent:"E-mail de confirmation renvoyé.",auth_err_unknown:"Erreur inconnue — réessaie.",lb_long_break_title:"Une pause plus longue ?",lb_long_break_body:"Tu as planifié 4 blocs de suite. Une vraie pause aide à se relancer.",lb_long_break_skip:"Non merci",lb_long_break_added:"Pause de {n} min ajoutée",lb_long_break_note:"Longue pause",pause_streak_q:"{n} blocs sans pause — en ajouter une ?",pause_add:"＋ Pause",timer_extended:"+{n} min ajoutées",lb_unknown_friend:"Ami(e)",fr_timeout:"Le serveur ne répond pas. Vérifie ta connexion.",fr_rls_hint:"Accès à la base refusé. Vérifie les policies RLS dans Supabase.",
 ...
 agdo_plan_desc:"Divisez votre journée en blocs de focus",agdo_edit_desc:"Ajustez blocs, horaires et matières",agdo_remove_desc:"Effacez le plan d'étude de ce jour",agdo_exam_desc:"Marquez un examen ce jour-là",agdo_empty:"Rien de planifié",
...
TR.es = {
 ...
 home_vp_head:"Hecho para mantenerte concentrado",
 home_vp_plan_t:"Planifica con cabeza",home_vp_plan_d:"Convierte tu día en unos bloques concentrados — listo en segundos.",
 home_vp_focus_t:"Concéntrate a fondo",home_vp_focus_d:"Un temporizador tranquilo, pausas suaves, cero distracciones.",
 home_vp_together_t:"Mejor juntos",home_vp_together_d:"Ve a tus amigos estudiar en vivo y animaos mutuamente.",
 home_join_t:"Estudiad juntos",home_join_d:"Añade amigos, ve quién se concentra ahora y motivaos.",home_join_cta:"Crear cuenta gratis",
 home_divider_plan:"O planifica con tiempo",color:"Color",fill_fields:"Rellena la asignatura y la fecha.",
 home_social_studying_now:"amigos concentrados ahora",home_social_on_break:"en pausa",home_social_invite:"Añadir amigo",home_social_invite_short:"Invitar",
 nextup_label:"Próximamente",nextup_label_today:"En el plan de hoy",nextup_today:"hoy",nextup_tomorrow:"mañana",nextup_in_days:"en <b>{n} días</b>",
 nextup_exam:"examen de {subj} {when}",nextup_today_blocks:"{blk} para hoy",nextup_today_only:"{blk} en tu plan — empieza cuando quieras",n_block:"bloque",n_blocks:"bloques",
 ...
 no_subj_data:"Termina algunas sesiones para ver tu desglose por materia.",subj_add_cta:"Añadir materias",home_subj_nudge_t:"Añade tus materias",home_subj_nudge_d:"Con materias verás exactamente a dónde va tu tiempo de estudio.",home_subj_nudge_btn:"Añadir materias",
 ...
 dpl_start:"Inicio",dpl_until:"Hasta",dpl_planned:"Planificado",dpl_done_by:"Listo a",dpl_endtime:"Fin",
 ...
 qa_pop_title:"Añadir rápido",qa_dur:"Duración",qa_amount:"Cuántos",qa_subj_opt:"Materia (opcional)",qa_subj_none:"Ninguna",qa_add_n:"＋ Añadir {n}",qa_incl_breaks:"descansos incluidos",qa_added_n:"{n} bloques añadidos",
 ...
 nav_today:"Hoy",nav_overview:"Resumen del día",nav_stats:"Estadísticas y amigos",nav_stats_short:"Estadísticas",nav_quick_short:"Rápido",
 ov_total_today:"Foco total hoy",ov_progress:"Progreso",ov_blocks_planned:"bloques planificados",
 ov_week_goal:"Meta de la semana",ov_of:"de",ov_tips_today:"Consejo de hoy",
 ov_today:"Hoy",ov_together:"Enfocados juntos",ov_friend_online:"amigo en línea",ov_friends_online:"amigos en línea",
 ov_no_friends_active:"Ningún amigo estudiando ahora. Invita a algunos para motivaros juntos.",
 ov_cheer_start:"Empecemos.",ov_cheer_good:"¡Buen comienzo!",ov_cheer_busy:"¡Sigue así!",ov_cheer_goal:"¡Meta alcanzada!",
 ov_empty_t:"Aún no hay plan para hoy",ov_empty_d:"Planifica tu día con bloques de foco, descansos y tareas.",
 ...
 unit_h_short:"h",unit_min_short:"min",
 pq_how_many:"¿Cuántos?",pq_per_block:"Duración por bloque",pq_total_focus:"de enfoque total",pq_auto_break:"Descansos entre bloques",
 ...
 auth_err_invalid:"Correo o contraseña incorrectos.",auth_err_already:"Este correo ya está en uso.",auth_err_minpw:"La contraseña debe tener al menos 6 caracteres.",auth_err_connect:"Conexión fallida. Inténtalo de nuevo.",auth_check_email:"Confirma tu correo electrónico para activar tu cuenta.",auth_err_rate_limit:"Demasiados intentos. Por favor, inténtelo de nuevo más tarde.",auth_err_unconfirmed:"Tu cuenta aún no está confirmada. Revisa tu correo.",auth_resend:"Reenviar correo de confirmación",auth_resent:"Correo de confirmación reenviado.",auth_err_unknown:"Error desconocido — inténtalo de nuevo.",lb_long_break_title:"¿Una pausa más larga?",lb_long_break_body:"Has planeado 4 bloques seguidos. Una pausa larga te ayuda a recargar.",lb_long_break_skip:"No, gracias",lb_long_break_added:"Pausa de {n} min añadida",lb_long_break_note:"Pausa larga",pause_streak_q:"{n} bloques sin pausa — ¿añadir una?",pause_add:"＋ Pausa",timer_extended:"+{n} min añadidos",lb_unknown_friend:"Amigo/a",fr_timeout:"El servidor no responde. Comprueba tu conexión.",fr_rls_hint:"Acceso a la base denegado. Revisa las policies RLS en Supabase.",
 ...
 agdo_plan_desc:"Divide tu día en bloques de enfoque",agdo_edit_desc:"Ajusta bloques, horarios y materias",agdo_remove_desc:"Borra el plan de estudio de este día",agdo_exam_desc:"Marca un examen en este día",agdo_empty:"Nada planificado aún",
...
TR.ro = {
 ...
 home_vp_head:"Creat să te țină concentrat",
 home_vp_plan_t:"Planifică inteligent",home_vp_plan_d:"Transformă-ți ziua în câteva blocuri concentrate — gata în secunde.",
 home_vp_focus_t:"Concentrare profundă",home_vp_focus_d:"Un cronometru calm, pauze blânde, zero distrageri.",
 home_vp_together_t:"Mai bine împreună",home_vp_together_d:"Vezi prietenii studiind live și motivați-vă reciproc.",
 home_join_t:"Studiați împreună",home_join_d:"Adaugă prieteni, vezi cine se concentrează acum și motivați-vă.",home_join_cta:"Creează cont gratuit",
 home_divider_plan:"Sau planifică din timp",color:"Culoare",fill_fields:"Completează materia și data.",
 home_social_studying_now:"prieteni studiază acum",home_social_on_break:"în pauză",home_social_invite:"Adaugă prieten",home_social_invite_short:"Invită",
 nextup_label:"Urmează",nextup_label_today:"În planul de azi",nextup_today:"azi",nextup_tomorrow:"mâine",nextup_in_days:"peste <b>{n} zile</b>",
 nextup_exam:"examen {subj} {when}",nextup_today_blocks:"{blk} azi",nextup_today_only:"{blk} în plan — gata oricând",n_block:"bloc",n_blocks:"blocuri",
 ...
 no_subj_data:"Termină câteva sesiuni ca să vezi defalcarea pe materii.",subj_add_cta:"Adaugă materii",home_subj_nudge_t:"Adaugă materiile tale",home_subj_nudge_d:"Cu materii vezi exact unde merge timpul tău de studiu.",home_subj_nudge_btn:"Adaugă materii",
 ...
 comp_plant_d:"Calm, natural, crește prin consecvență.",comp_cat_d:"Confortabil și liniștit la birou.",comp_dog_d:"Loial și stabil lângă tine.",comp_fire_d:"Lumini blânde care se adună.",comp_bot_d:"Îți construiește casa de studiu, bloc cu bloc.",comp_zen_d:"Ultra-minimal. Fără distrageri.",comp_lamp_d:"O lumină caldă ce devine mai puternică.",comp_none_d:"Nici un companion.",
 ...
 dpl_start:"Start",dpl_until:"Până la",dpl_planned:"Planificat",dpl_done_by:"Gata la",dpl_endtime:"Sfârșit",
 ...
 qa_pop_title:"Adaugă rapid",qa_dur:"Durată",qa_amount:"Câte",qa_subj_opt:"Materie (opțional)",qa_subj_none:"Niciuna",qa_add_n:"＋ Adaugă {n}",qa_incl_breaks:"pauze incluse",qa_added_n:"{n} blocuri adăugate",
 ...
 nav_today:"Astăzi",nav_overview:"Rezumatul zilei",nav_stats:"Statistici și prieteni",nav_stats_short:"Statistici",nav_quick_short:"Rapid",
 ov_total_today:"Total focus azi",ov_progress:"Progres",ov_blocks_planned:"blocuri planificate",
 ov_week_goal:"Obiectiv săptămânal",ov_of:"din",ov_tips_today:"Sfat pentru azi",
 ov_today:"Astăzi",ov_together:"Concentrați împreună",ov_friend_online:"prieten online",ov_friends_online:"prieteni online",
 ov_no_friends_active:"Niciun prieten nu învață acum. Invită câțiva ca să rămâneți motivați împreună.",
 ov_cheer_start:"Să începem.",ov_cheer_good:"Început bun!",ov_cheer_busy:"Continuă așa!",ov_cheer_goal:"Obiectiv atins!",
 ov_empty_t:"Încă niciun plan pentru azi",ov_empty_d:"Planifică-ți ziua cu blocuri de focus, pauze și sarcini.",
 ...
 unit_h_short:"h",unit_min_short:"min",
 pq_how_many:"Câte?",pq_per_block:"Durata per bloc",pq_total_focus:"focus total",pq_auto_break:"Pauze între blocuri",
 ...
 auth_err_invalid:"E-mail sau parolă incorectă.",auth_err_already:"Acest e-mail este deja folosit.",auth_err_minpw:"Parola trebuie să aibă cel puțin 6 caractere.",auth_err_connect:"Conexiune eșuată. Încearcă din nou.",auth_check_email:"Confirmă adresa de e-mail pentru a-ți activa contul.",auth_err_rate_limit:"Prea multe încercări. Vă rugăm să încercați din nou mai târziu.",auth_err_unconfirmed:"Contul tău nu este încă confirmat. Verifică e-mailul.",auth_resend:"Retrimite e-mailul de confirmare",auth_resent:"E-mail de confirmare retrimis.",auth_err_unknown:"Eroare necunoscută — încearcă din nou.",lb_long_break_title:"Timp pentru o pauză mai lungă?",lb_long_break_body:"Ai planificat 4 blocuri la rând. O pauză mai lungă te ajută să te resetezi.",lb_long_break_skip:"Nu, mulțumesc",lb_long_break_added:"Pauză de {n} min adăugată",lb_long_break_note:"Pauză lungă",pause_streak_q:"{n} blocuri fără pauză — adaugi una?",pause_add:"＋ Pauză",timer_extended:"+{n} min adăugate",lb_unknown_friend:"Prieten",fr_timeout:"Serverul nu răspunde. Verifică conexiunea.",fr_rls_hint:"Acces la bază refuzat. Verifică policies RLS în Supabase.",
 ...
 agdo_plan_desc:"Împarte ziua în blocuri de focus",agdo_edit_desc:"Ajustează blocuri, ore și materii",agdo_remove_desc:"Șterge planul de studiu din această zi",agdo_exam_desc:"Marchează un examen în această zi",agdo_empty:"Nimic planificat încă",
...
/* Flavor-sublabels voor de snelle-blokken duur-pillen (per taal) */
const PQ_SUB = {
 en:{15:'Quick',25:'Classic',30:'Short',45:'Solid',50:'Deep',60:'Long',75:'Strong',90:'Marathon',120:'Ultra'},
 nl:{15:'Snel',25:'Klassiek',30:'Kort',45:'Goed',50:'Diep',60:'Lang',75:'Sterk',90:'Marathon',120:'Ultra'},
 fr:{15:'Rapide',25:'Classique',30:'Court',45:'Solide',50:'Profond',60:'Long',75:'Intense',90:'Marathon',120:'Ultra'},
 es:{15:'Rápido',25:'Clásico',30:'Corto',45:'Sólido',50:'Profundo',60:'Largo',75:'Intenso',90:'Maratón',120:'Ultra'},
 ro:{15:'Rapid',25:'Clasic',30:'Scurt',45:'Solid',50:'Profund',60:'Lung',75:'Intens',90:'Maraton',120:'Ultra'},
};
function pqSub(m){ const map = PQ_SUB[S.lang] || PQ_SUB.en; return map[m] || 'min'; }
